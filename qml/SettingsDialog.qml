            ...
            Item {
                ...
                ScrollView {
                    ...
                    ColumnLayout {
                        ...
                        Repeater {
                            model: [
                                { key: "volumeUp", label: qsTr("Volume Up") },
                                { key: "volumeDown", label: qsTr("Volume Down") },
                                { key: "toggleMute", label: qsTr("Toggle Mute") },
                                { key: "togglePlayback", label: qsTr("Play / Pause") },
                                { key: "stepBackward", label: qsTr("Step Backward") },
                                { key: "stepForward", label: qsTr("Step Forward") },
                                { key: "stepBackwardLarge", label: qsTr("Large Backward") },
                                { key: "stepForwardLarge", label: qsTr("Large Forward") },
                                { key: "toggleFullscreen", label: qsTr("Toggle Fullscreen") },
                                { key: "exitFullscreen", label: qsTr("Exit Fullscreen") },
